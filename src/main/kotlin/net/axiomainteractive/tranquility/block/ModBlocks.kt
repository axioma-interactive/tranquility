...
object ModBlocks {
    ...
    val MASONIC_STONE: Block = registerBlock("masonic_stone", AbstractBlock.Settings.create()
        .strength(2f, 6f)
        .requiresTool()
        .sounds(BlockSoundGroup.STONE)
    )
    ...
    val COMPACT_MOSSY_MASONIC_COBBLESTONE: Block = registerBlock("compact_mossy_masonic_cobblestone", AbstractBlock.Settings.create()
        .strength(4f)
        .requiresTool()
        .sounds(BlockSoundGroup.STONE)
    )
